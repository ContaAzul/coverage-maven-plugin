...
public class ClazzMapperTest {
	...
	public void init() throws IOException {
		TestResources.setup();
		coverage = new Parser()
				.parse(new File(TestResources.COVERAGE_XML_FILE));
	...
	public void testGetClazz() throws Exception {
		Clazz clazz = mapper
				.getClazz("src/main/java/com/contaazul/coverage/CoveragePullRequestMojo");
		assertTrue(clazz instanceof Clazz);
		assertTrue(clazz.getName().equals(
				"com.contaazul.coverage.CoveragePullRequestMojo"));
	}

	@Test
	public void testGetClazzDotJava() throws Exception {
		Clazz clazz = mapper
				.getClazz("src/main/java/com/contaazul/coverage/CoveragePullRequestMojo.java");
		assertTrue(clazz instanceof Clazz);
		assertTrue(clazz.getName().equals(
				"com.contaazul.coverage.CoveragePullRequestMojo"));
	}
	...
	public void getInvalidClazzPath() throws Exception {
		Clazz clazz = mapper
				.getClazz("xsrc/main/java/com/contaazul/coverage/CoveragePullRequestMojo");
		assertNull(clazz);
	}
	...
	public void testWrongPackageName() throws Exception {
		Clazz clazz = mapper
				.getClazz("src/main/java/com/contaazul/coveragersrs/CoveragePullRequestMojo");
		assertNull(clazz);
	}
	...
	public void getInvalizClazzName() throws Exception {
		Clazz clazz = mapper
				.getClazz("src/main/java/com/contaazul/coverage/CoveragePullRequestMojozz");
		assertNull(clazz);
	}
}
